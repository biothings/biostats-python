...
class MyVariant extends React.Component {
  ...
  constructor(props) {
    ...
    this.state={
        ...
        top5PagesURL:'https://gasuperproxy-1470690417190.appspot.com/query?id=ahxzfmdhc3VwZXJwcm94eS0xNDcwNjkwNDE3MTkwchULEghBcGlRdWVyeRiAgICA3oyQCgw',
        top5ActionsURL:'https://gasuperproxy-1470690417190.appspot.com/query?id=ahxzfmdhc3VwZXJwcm94eS0xNDcwNjkwNDE3MTkwchULEghBcGlRdWVyeRiAgIDA05CWCgw',
        activeUsers: 0,
        totalUsers: 0,
        results:[],
        lastActiveUsers:0,
    ...
    return (
      <section className="margin0Auto padding20 centerText mV-back">
        <div style={{width:'100%', clear:'both'}}>
          ...
          <button style={{position:'absolute', right:'20px'}} className='btn btn-green' onClick={this.fetchAnalyticsData}>Refresh</button>
        </div>
